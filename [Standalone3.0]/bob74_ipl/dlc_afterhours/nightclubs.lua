...
AfterHoursNightclubs = {
    ...
    LoadDefault = function()
        ...
        AfterHoursNightclubs.Interior.Lights.Neons.Set(AfterHoursNightclubs.Interior.Lights.Neons.Clear)
        AfterHoursNightclubs.Interior.Lights.Bands.Set(AfterHoursNightclubs.Interior.Lights.Bands.Clear)
        ...
        AfterHoursNightclubs.Interior.Trophy.Enable(AfterHoursNightclubs.Interior.Trophy.Color.gold, true, AfterHoursNightclubs.Interior.Trophy.Color.gold)
        -- AfterHoursNightclubs.Interior.DryIce.Enable(AfterHoursNightclubs.Interior.DryIce.Emitters)
        -- AfterHoursNightclubs.Interior.DryIce.Enable(AfterHoursNightclubs.Interior.DryIce.scale)
        AfterHoursNightclubs.Interior.Details.Enable(AfterHoursNightclubs.Interior.Details.clutter, true)
        ...
        -- AfterHoursNightclubs.Interior.Details.Enable(AfterHoursNightclubs.Interior.Details.lightRigsOff, true)
        ...
        AfterHoursNightclubs.Interior.Details.Enable(AfterHoursNightclubs.Interior.Details.vaultMeth, true)
        AfterHoursNightclubs.Interior.Details.Enable(AfterHoursNightclubs.Interior.Details.vaultFakeID, true)
        AfterHoursNightclubs.Interior.Details.Enable(AfterHoursNightclubs.Interior.Details.vaultWeed, true)
        AfterHoursNightclubs.Interior.Details.Enable(AfterHoursNightclubs.Interior.Details.vaultCoke, true)
