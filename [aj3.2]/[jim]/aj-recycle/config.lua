...
Config.Locations =  {
	['Recycle'] = { name = "Recycle Center", location = vector3(744.68,-1401.77, 26.55-1.03), heading = 248.73, blipTrue = false, Sprite = 365, Scale = 0.8, Colour = 2, },
	['Trade'] = { name = "Recyclable Trader", location = vector3(996.58,-3098.45,-39.0-1.03), heading = 230.0, blipTrue = false, Sprite = 365, Scale = 0.8, Colour = 2, },
}
...
Config.DumpItems = {
    "empty_bag", "empty_weed_bag", "empty_bottle", 
	"sandwich",
	"water_bottle",
	"metalscrap",
	"steel",
