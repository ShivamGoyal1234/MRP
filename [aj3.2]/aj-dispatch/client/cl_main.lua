...
RegisterNetEvent('dispatch:manageNotifs', function(sentSetting)
    ...
    if wantedSetting == "on" then
        ...
        AJFW.Functions.Notify("Dispatch enabled", "success")
    elseif wantedSetting == "off" then
        disableNotis = true
        disableNotifSounds = true
        AJFW.Functions.Notify("Dispatch disabled", "success")
    elseif wantedSetting == "mute" then
        disableNotis = false
        disableNotifSounds = true
        AJFW.Functions.Notify("Dispatch muted", "success")
    else
        AJFW.Functions.Notify('Please choose to have dispatch as "on", "off" or "mute".', "success")
...
RegisterNetEvent("aj-dispatch:client:AddCallBlip")
AddEventHandler("aj-dispatch:client:AddCallBlip", function(coords, data)
