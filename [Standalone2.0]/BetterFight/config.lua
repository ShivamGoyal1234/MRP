...
Config.Weapons= {
    ...
    [29] = { hash = `WEAPON_PUMPSHOTGUN_MK2`, recoil = 3.50, rightLeftRecoil = 1.00, vehicleRecoil = 1.10, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.30},
    ...
    --Assault Rifles--
    [38] = { hash = `WEAPON_ASSAULTRIFLE`, recoil = 1.50, rightLeftRecoil = 1.00, vehicleRecoil = 1.10, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.40, suppressorMultiplier = 0.72, damageMultiplier = 1.10},
    ...
    [95] = { hash = `WEAPON_M4A4`, recoil = 0.10, rightLeftRecoil = 0.10, vehicleRecoil = 1.10, vehicleRightLeftRecoil = 2.00, gripMultiplier = 0.80, suppressorMultiplier = 0.72, damageMultiplier = 0.60},
