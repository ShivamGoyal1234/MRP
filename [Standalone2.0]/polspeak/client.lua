...
mainMenu = NativeUI.CreateMenu("MR Police Mic", "~b~POLICE MEGAPHONE")
menuPool:Add(mainMenu)

function AddMenuAnotherMenu(menu)
    local submenu = menuPool:AddSubMenu(menu, "Stop the vehicle »", "Various stop vehicle commands")
...
function Stop(menu)
    local submenu4 = menuPool:AddSubMenu(menu, "Stop »", "Various stop commands")
...
function Clear(menu)
    local submenu2 = menuPool:AddSubMenu(menu, "Clear area »", "Clear the area")
...
function Insults(menu)
    local submenu3 = menuPool:AddSubMenu(menu, "Insults »", "Various insults")
...
function General(menu)
	local submenu5 = menuPool:AddSubMenu(menu, "General »", "General Voices")
