...
RegisterNetEvent("aj-fishing:tryToFish")
AddEventHandler("aj-fishing:tryToFish", function(item)
	TryToFish(item) 
end)

RegisterNetEvent("aj-fishing:calculatedistances")
AddEventHandler("aj-fishing:calculatedistances", pos, function()
