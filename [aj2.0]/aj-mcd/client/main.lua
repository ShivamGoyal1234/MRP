...
function StrawberryFilling()
    ...
    AJFW.Functions.Progressbar("empty_bottle", "Filling Strawberry Banana Smoothie ..", 8000, false, true, {
...
function MangoFilling()
    ...
    TriggerEvent("inventory:client:ItemBox", AJFW.Shared.Items["mcd-glass"], "remove")
    TriggerServerEvent("InteractSound_SV:PlayOnSource", "sodaop", 0.8)
    AJFW.Functions.Progressbar("empty_bottle", "Filling Mango Pineapple Smoothie ..", 8000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
...
function iceFilling()
    ...
    TriggerEvent("inventory:client:ItemBox", AJFW.Shared.Items["mcd-glass"], "remove")
    TriggerServerEvent("InteractSound_SV:PlayOnSource", "sodaop", 0.8)
    AJFW.Functions.Progressbar("empty_bottle", "Filling Ice tea ..", 8000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
...
function icedFilling()
    ...
    TriggerEvent("inventory:client:ItemBox", AJFW.Shared.Items["mcd-glass"], "remove")
    TriggerServerEvent("InteractSound_SV:PlayOnSource", "sodaop", 0.8)
    AJFW.Functions.Progressbar("empty_bottle", "Filling Iced Latte ..", 8000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
...
function cappuccinoFilling()
    ...
    AJFW.Functions.Progressbar("empty_bottle", "Filling Cappuccino ..", 10000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
...
function ChocolateFilling()
    ...
    TriggerEvent("inventory:client:ItemBox", AJFW.Shared.Items["mcd-cup"], "remove")
    TriggerServerEvent("InteractSound_SV:PlayOnSource", "cmaking", 0.8)
    AJFW.Functions.Progressbar("empty_bottle", "Filling Hot Chocolate ..", 10000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
...
function CaramelFilling()
    ...
    TriggerEvent("inventory:client:ItemBox", AJFW.Shared.Items["mcd-cup"], "remove")
    TriggerServerEvent("InteractSound_SV:PlayOnSource", "cmaking", 0.8)
    AJFW.Functions.Progressbar("empty_bottle", "Filling Caramel Latte ..", 10000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
...
Citizen.CreateThread(function()
    ---Tables
    exports['aj-eye']:AddBoxZone("McdTable", vector3(75.7, 282.19, 110.21), 1.0, 1.6, { name="McdTable", heading = 91.0, debugPoly=true, minZ=21.49, maxZ=22.89 }, 
        { options = { {  event = "mcd-table:Stash", icon = "fas fa-box-open", label = "Table", stash = "Table_1" }, }, distance = 2.0 })
    -- exports['aj-eye']:AddBoxZone("McdTable2", vector3(-573.44, -1063.45, 22.34), 1.9, 1.0, { name="McdTable", heading = 91.0, debugPoly=debug, minZ=21.49, maxZ=22.89 }, 
    --     { options = { {  event = "mcd-table:Stash", icon = "fas fa-box-open", label = "Table", stash = "Table_2" }, }, distance = 2.0 })
    -- exports['aj-eye']:AddBoxZone("McdTable3", vector3(-573.41, -1067.09, 22.49), 1.9, 1.0, { name="McdTable", heading = 91.0, debugPoly=debug, minZ=21.49, maxZ=22.89 }, 
    --     { options = { {  event = "mcd-table:Stash", icon = "fas fa-box-open", label = "Table", stash = "Table_3" }, }, distance = 2.0 })
    -- exports['aj-eye']:AddBoxZone("McdTable4", vector3(-578.68, -1051.09, 22.35), 1.2, 0.9, { name="McdTable", heading = 91.0, debugPoly=debug, minZ=21.49, maxZ=22.89 }, 
