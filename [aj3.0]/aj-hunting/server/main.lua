...
RegisterNetEvent('Hunting:Server:TakeDeposit', function()
    ...
    if money >= Config.StartDeposit then
        ...
        TriggerClientEvent("AJFW:Notify", src, "You don't have enough money in your bank", "error", 5000)
    end
end)
...
RegisterNetEvent('Hunting:Server:Reward', function(weight)
    ...
    if weight >= 1 then
        ...
        TriggerClientEvent("inventory:client:ItemBox", source, AJFW.Shared.Items['meat'], "add")
...
RegisterNetEvent('Hunting:Server:process', function(heading)
    ...
    if meat ~= nil then
        ...
        TriggerClientEvent("AJFW:Notify", src, "You don't have Meat in your inventory", "error", 5000)
    end
end)
...
RegisterNetEvent('Hunting:Server:GetItemProcessed', function()
    ...
    if meat ~= nil then
        ...
        TriggerClientEvent("AJFW:Notify", src, "nalla samjha he ka", "error", 5000)
    end
end)
...
RegisterNetEvent('Hunting:Server:Packing', function(heading)
    ...
    if meat ~= nil then
        if box ~= nil then
            ...
            TriggerClientEvent("AJFW:Notify", src, "You don't have Empty Box in your inventory", "error", 5000)
        end
    else
        TriggerClientEvent("AJFW:Notify", src, "You don't have slaughtered meat in your inventory", "error", 5000)
    end
end)
...
RegisterNetEvent('Hunting:Server:Selling', function()
    ...
    if meat ~= nil then
        ...
        TriggerClientEvent("AJFW:Notify", src, "You don't have Packed meat in your inventory", "error", 5000)
    end
end)
