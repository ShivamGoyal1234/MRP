...
AddEventHandler('aj-chopshop:wheelanimation', function()
	...
	AJFW.Functions.Progressbar("wheel", Config.Locale["Wheel"], 7000, false, true, {
...
AddEventHandler('aj-chopshop:dooranimation', function()
	...
	AJFW.Functions.Progressbar("Door1", Config.Locale["Door1"], (4000), false, true, {
	    disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
	...
	AJFW.Functions.Progressbar("Door2", Config.Locale["Door2"], (4000), false, true, {
		disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
...
AddEventHandler('aj-chopshop:trunkanimation', function()
	...
	AJFW.Functions.Progressbar("Trunk1", Config.Locale["searching"], (4000), false, true, {
	    disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
	...
	Citizen.Wait(4500)
	TriggerEvent('animations:client:EmoteCommandStart', {"mechanic4"})
	AJFW.Functions.Progressbar("Hood1", Config.Locale["Door1"], (4000), false, true, {
	    disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
	...
	Citizen.Wait(4500)
	TriggerEvent('animations:client:EmoteCommandStart', {"pull"})
	AJFW.Functions.Progressbar("Hood2", Config.Locale["Door2"], (4000), false, true, {
		disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
...
AddEventHandler('aj-chopshop:wheelchopanim', function()
	local ped = PlayerPedId()
	AJFW.Functions.Progressbar("wheel", Config.Locale["chopwheel"], 13000, false, true, {
		disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
...
AddEventHandler('aj-chopshop:doorchopanim', function()
	local ped = PlayerPedId()    
	AJFW.Functions.Progressbar("door", Config.Locale["chopdoor"], 13000, false, true, {
		disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
...
AddEventHandler('aj-chopshop:hoodchopanim', function()
	local ped = PlayerPedId()    
	AJFW.Functions.Progressbar("hood", Config.Locale["chophood"], 12500, false, true, {
		disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
...
AddEventHandler('aj-chopshop:trunkchopanim', function()
	local ped = PlayerPedId()
	AJFW.Functions.Progressbar("trunk", Config.Locale["choptrunk"], 12500, false, true, {
		disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
