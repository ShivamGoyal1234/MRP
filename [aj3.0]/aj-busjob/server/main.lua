...
RegisterNetEvent('aj-busjob:server:NpcPay', function(Payment)
    local src = source
...
RegisterNetEvent('aj-busjob:server:Deposit', function()
    local src = source
    local Player = AJFW.Functions.GetPlayer(src)
    Player.Functions.RemoveMoney('cash', 500)
end)

RegisterNetEvent('aj-busjob:server:Withdraw', function()
    local src = source
    local Player = AJFW.Functions.GetPlayer(src)
