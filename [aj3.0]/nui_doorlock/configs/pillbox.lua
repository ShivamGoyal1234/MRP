...
-- doctor garage - Wooden double door from hallway
table.insert(Config.DoorList, {
	doors = {
...
-- doctor garage - Elevator right (from garage)
-- table.insert(Config.DoorList, {
-- 	doors = {
...
-- doctor garage - Elevator left (from garage)
-- table.insert(Config.DoorList, {
-- 	doors = {
...
-- WARD A created by Ayush Abhinav
Config.DoorList['WARD A'] = {
    doors = {
...
-- WARD B created by Ayush Abhinav
Config.DoorList['WARD B'] = {
    doors = {
        {objHash = -434783486, objHeading = 249.98275756836, objCoords = vec3(349.313751, -586.325989, 43.433910)},
        {objHash = -1700911976, objHeading = 249.98275756836, objCoords = vec3(348.433319, -588.744995, 43.433910)}
    },
    lockpick = false,
    audioRemote = false,
    maxDistance = 2.5,
...
-- Main Hall created by Ayush Abhinav
Config.DoorList['Main Hall'] = {
    doors = {
        {objHash = -434783486, objHeading = 340.00003051758, objCoords = vec3(302.803070, -581.424561, 43.433910)},
        {objHash = -1700911976, objHeading = 340.00003051758, objCoords = vec3(305.221863, -582.305603, 43.433910)}
    },
    lockpick = false,
    audioRemote = false,
    maxDistance = 2.5,
...
-- Main Hall 2 created by Ayush Abhinav
Config.DoorList['Main Hall 2'] = {
    doors = {
