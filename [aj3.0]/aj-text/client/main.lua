...
RegisterNetEvent('aj-text:client:DrawText', function(text, position,r,g,b,a)
    DrawText(text, position,r,g,b,a)
end)

RegisterNetEvent('aj-text:client:ChangeText', function(text, position)
    ChangeText(text, position)
end)

RegisterNetEvent('aj-text:client:HideText', function()
    HideText()
end)

RegisterNetEvent('aj-text:client:KeyPressed', function()
    KeyPressed()
end)
