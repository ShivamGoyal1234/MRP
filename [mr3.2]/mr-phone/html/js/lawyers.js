SetupLawyers = function(data) {
    ...
    if (data.length > 0) {
        ...
        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(0, 204, 102);">Bennys (' + mechanic.length + ')</h1>');

        if (bennys.length > 0) {
            $.each(bennys, function(i, lawyer10) {
                var element = '<div class="lawyer-list" id="lawyerid10-' + i + '"> <div class="lawyer-list-firstletter" style="background-color: rgb(0, 204, 102);">' + (lawyer10.name).charAt(0).toUpperCase() + '</div> <div class="lawyer-list-fullname">' + lawyer10.name + '</div> <div class="lawyer-list-call"><i class="fas fa-phone"></i></div> </div>'
                $(".lawyers-list").append(element);
                $("#lawyerid10-" + i).data('LawyerData', lawyer10);
            });
        } else {
            var element = '<div class="lawyer-list"><div class="no-lawyers">There are no Bennys available.</div></div>'
            $(".lawyers-list").append(element);
        }
        ...
        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(255, 0, 0);">Ambulance (' + doctor.length + ')</h1>');

        if (doctor.length > 0) {
            $.each(doctor, function(i, lawyer5) {
         ...
         if (pdm.length > 0) {
             ...
             var element = '<div class="lawyer-list"><div class="no-lawyers">There is no pdm available..</div></div>'
             $(".lawyers-list").append(element);
         }
         // edm
         $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(255, 110, 176);">EDM (' + edm.length + ')</h1>');
 
         if (edm.length > 0) {
             $.each(edm, function(i, lawyer7) {
                 var element = '<div class="lawyer-list" id="lawyerid7-' + i + '"> <div class="lawyer-list-firstletter" style="background-color: rgb(255, 110, 176);">' + (lawyer7.name).charAt(0).toUpperCase() + '</div> <div class="lawyer-list-fullname">' + lawyer7.name + '</div> <div class="lawyer-list-call"><i class="fas fa-phone"></i></div> </div>'
                 $(".lawyers-list").append(element);
                 $("#lawyerid7-" + i).data('LawyerData', lawyer7);
             });
         } else {
             var element = '<div class="lawyer-list"><div class="no-lawyers">There is no edm available..</div></div>'
             $(".lawyers-list").append(element);
         }
         // mcd
         $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(255, 0, 0);">MCD (' + mcd.length + ')</h1>');
 
         if (mcd.length > 0) {
             $.each(mcd, function(i, lawyer8) {
             ...
             var element = '<div class="lawyer-list"><div class="no-lawyers">There is no mcd available..</div></div>'
             $(".lawyers-list").append(element);
         }
         ...
         if (catcafe.length > 0) {
             $.each(catcafe, function(i, lawyer9) {
                 var element = '<div class="lawyer-list" id="lawyerid9-' + i + '"> <div class="lawyer-list-firstletter" style="background-color: rgb(255, 0, 0);">' + (lawyer9.name).charAt(0).toUpperCase() + '</div> <div class="lawyer-list-fullname">' + lawyer9.name + '</div> <div class="lawyer-list-call"><i class="fas fa-phone"></i></div> </div>'
                 $(".lawyers-list").append(element);
        ...
        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(0, 204, 102);">Bennys (' + bennys.length + ')</h1>');
        ...
        var element = '<div class="lawyer-list"><div class="no-lawyers">There are no doctor personnel a available.</div></div>'
        $(".lawyers-list").append(element);
        ...
        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(255, 110, 176);">MCD (' + mcd.length + ')</h1>');

        var element = '<div class="lawyer-list"><div class="no-lawyers">There is no mcd available.</div></div>'
        $(".lawyers-list").append(element);

        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(255, 110, 176);">Catcafe (' + catcafe.length + ')</h1>');
...
$(document).on('click', '.lawyer-list-call', function(e){
    ...
    $.post('https://mr-phone/CallContact', JSON.stringify({
        ContactData: cData,
