CreateThread(function()
    ...
    exports['mr-eye']:AddTargetBone(Config.PetrolCanRefuelBones,{ 
        options = {
            { 
                type = "client",
    ...
    exports['mr-eye']:AddTargetBone(Config.SiphonBones,{
        options = {
            {
                type="client",
    ...
    exports['mr-eye']:AddTargetModel(Config.GasPumpModels, {
        options = {
            {
                icon = "fas fa-gas-pump",
                label = "Get Fuel",
