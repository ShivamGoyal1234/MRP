...
$(document).ready(() => {
            ...
            `
                            <div class="profile-item" data-id="0">
                                ...
                                <div style="display: flex; flex-direction: column;">
                                    <div class="profile-item-title">No Vehicle Matching that search</div>
                                    </div>
  ...
  function JobColors(sentJob) {
    if (sentJob) {
      ...
      } else if (DoctorJobs[sentJob] !== undefined) {
  ...
  window.addEventListener("message", function (event) {
    ...
    if (eventData.type == "show") {
      if (eventData.enable == true) {
        ...
        /* if (PoliceJobs[playerJob] !== undefined || DoctorJobs[playerJob] !== undefined) {
          $(".manage-profile-save").css("display", "block");
          $(".manage-profile-editing-title").css("display", "block");
          $(".manage-incidents-create").css("display", "block");
          $(".manage-incidents-save").css("display", "block");
      ...
      activeUnits.forEach((unit) => {
        ...
        } else if (DoctorJobs[unit.unitType] !== undefined) {
          activeInfoJob = `<div class="unit-job active-info-job-doctor">EMS</div>`
          emsCount++;
