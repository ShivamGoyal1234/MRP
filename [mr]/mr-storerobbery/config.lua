...
Config.Safes = {
    ...
    [3] = {vector4(-1220.85, -916.05, 11.32,  229.5), type = "keypad", robbed = false, camId = 6},
    [4] = {vector4(-709.74, -904.15, 19.21, 229.5), type = "keypad", robbed = false, camId = 7},
    [5] = {vector3(31.25, -1339.25, 29.5), type = "keypad", robbed = false, camId = 8},
    [6] = {vector3(1126.77, -980.1, 45.41), type = "keypad", robbed = false, camId = 9},
    [7] = {vector3(1159.46, -314.05, 69.2), type = "keypad", robbed = false, camId = 10},
    [8] = {vector3(381.11, 332.53, 103.57), type = "keypad", robbed = false, camId = 11},
    ...
    [11] = {vector3(-3048.79, 588.44, 7.91), type = "keypad", robbed = false, camId = 14},
    [12] = {vector3(-3249.71, 1007.37, 12.83), type = "keypad", robbed = false, camId = 15},
    ...
    [15] = {vector3(2674.25, 3289.22, 55.24), type = "keypad", robbed = false, camId = 18},
    [16] = {vector3(1961.79, 3750.33, 32.34), type = "keypad", robbed = false, camId = 19},
    [17] = {vector3(1737.42, 6419.38, 35.04), type = "keypad", robbed = false, camId = 20},
    [18] = {vector3(-168.40, 6318.80, 30.58), type = "keypad", robbed = false, camId = 27},
    [19] = {vector3(170.93, 6642.52, 31.7), type = "keypad", robbed = false, camId = 30},
}
