...
RegisterNetEvent('mr-radialmenu:ResetClothing')
AddEventHandler('mr-radialmenu:ResetClothing', ResetClothing)
...
RegisterNetEvent('mr-radialmenu:ToggleClothing')
AddEventHandler('mr-radialmenu:ToggleClothing', ToggleClothing)
...
RegisterNetEvent('mr-radialmenu:ToggleProps')
AddEventHandler('mr-radialmenu:ToggleProps', ToggleProps)
...
function Notify(message, color) -- However you want your notifications to be shown, you can switch it up here.
	MRFW.Functions.Notify(message, color)
end
