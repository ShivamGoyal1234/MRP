...
Config.MenuItems = {
        ...
        items = {
            {
                ...
                icon = 'gas-pump',
                type = 'client',
                event = 'mr-radialmenu:client:togglegas',
                shouldClose = true
            }, {
                id = 'barbershop',
                title = 'Barber Shop',
                icon = 'cut',
                type = 'client',
                event = 'mr-radialmenu:client:togglebarber',
                shouldClose = true
            }, {
                id = 'clothing',
                title = 'Clothing Shop',
                icon = 'tshirt',
                type = 'client',
                event = 'mr-radialmenu:client:toggleclothing',
                shouldClose = true
            }, {
                id = 'store',
                title = 'Stores',
                icon = 'store',
                type = 'client',
                event = 'mr-radialmenu:client:togglestores',
                shouldClose = true
            }, {
                id = 'benny',
                title = 'Bennys',
                icon = 'paint-roller',
                type = 'client',
                event = 'mr-radialmenu:client:togglebenny',
                shouldClose = true
            }, {
                id = 'ammunation',
                title = 'Ammunation',
                icon = 'crosshairs',
                type = 'client',
                event = 'mr-radialmenu:client:togglegun',
                shouldClose = true
            }
        }
    },
    ...
    --         --     icon = 'address-book',
    --         --     type = 'client',
    --         --     event = 'mr-phone:client-annphonenumber',
    --         --     shouldClose = true
    --         -- }, 
    --         {
    --             id = 'getintrunk',
    ...
    --             icon = 'cannabis',
    --             type = 'client',
    --             event = 'mr-drugs:client:cornerselling',
    --             shouldClose = true
    --         }, {
    --             id = 'togglehotdogsell',
    ...
    --             icon = 'hotdog',
    --             type = 'client',
    --             event = 'mr-hotdogjob:client:ToggleSell',
    --             shouldClose = true
    --         }, --[[{
    --             id = 'searchplayerBag',
    --             title = 'Search Bag',
    --             icon = 'search',
    --             type = 'client',
    --             event = 'police:client:SearchPlayerBag2',
    --             shouldClose = true
    --         },]] {
    --             id = 'interactions',
    --             title = 'Interaction',
                ...
                items = {
                    {
                        ...
                        icon = 'key',
                        type = 'client',
                        event = 'mr-houses:client:giveHouseKey',
                        shouldClose = true,
                        items = {}
                    }, {
                        id = 'removehousekey',
                        ...
                        icon = 'key',
                        type = 'client',
                        event = 'mr-houses:client:removeHouseKey',
                        shouldClose = true,
                        items = {}
                    }, {
                        id = 'togglelock',
                        ...
                        icon = 'door-closed',
                        type = 'client',
                        event = 'mr-houses:client:toggleDoorlock',
                        shouldClose = true
                    }, {
                        id = 'decoratehouse',
                        ...
                        icon = 'boxes',
                        type = 'client',
                        event = 'mr-houses:client:decorate',
                        shouldClose = true
                    }, {
                        id = 'houseLocations',
                        ...
                        items = {
                            {
                                ...
                                icon = 'box-open',
                                type = 'client',
                                event = 'mr-houses:client:setLocation',
                                shouldClose = true
                            }, {
                                id = 'setoutift',
                                title = 'Set Wardrobe',
                ...
                items = {
                    {
                        ...
                        icon = 'user',
                        type = 'client',
                        event = 'mr-radialmenu:ToggleClothing',
                        shouldClose = true
                    }, {
                        id = 'Ear',
                        title = 'Ear Piece',
                        icon = 'deaf',
                        type = 'client',
                        event = 'mr-radialmenu:ToggleProps',
                        shouldClose = true
                    }, {
                        id = 'Neck',
                        title = 'Neck',
        ...
        items = {
            {
                ...
                items = {
                    {
                        ...
                        icon = 'car-side',
                        type = 'client',
                        event = 'mr-radialmenu:client:openDoor',
                        shouldClose = false
                    }, {
                        id = 'door4',
                        title = 'Hood',
                ...
                icon = 'toolbox',
                type = 'client',
                event = 'mr-radialmenu:client:flip:vehicle',
                shouldClose = true,
            }, {
                id    = 'vehiclehealth',
                title = 'Check vehicle',
                icon = 'toolbox',
                type = 'client',
                event = 'mr-radialmenu:check:vehiclehealth',
                shouldClose = true,
            },
        }
    },
    ...
    ["doctor"] = {
        {
            ...
            icon = 'bell',
            type = 'client',
            event = 'mr-dispatch:client:emsdown',
            shouldClose = true
        }, {
            id = 'escort',
            title = 'Escort',
            ...
            items = {
                {
                    ...
                    icon = 'plus',
                    type = 'client',
                    event = 'mr-radialmenu:client:TakeStretcher',
                    shouldClose = false
                }, {
                    id = 'despawnstretcher',
                    ...
                    icon = 'minus',
                    type = 'client',
                    event = 'mr-radialmenu:client:RemoveStretcher',
                    shouldClose = false
                }
            }
        }
    ...
    ["taxi"] = {
        {
            ...
            icon = 'eye-slash',
            type = 'client',
            event = 'mr-taxi:client:toggleMeter',
            shouldClose = false
        }, {
            id = 'togglemouse',
            ...
            type = 'client',
            event = 'mr-taxi:client:enableMeter',
            shouldClose = true
        }, {
            id = 'npc_mission',
            title = 'NPC Mission',
            icon = 'taxi',
            type = 'client',
            event = 'mr-taxi:client:DoTaxiNpc',
            shouldClose = true
        }
    },
    ["tow"] = {
        {
            ...
            icon = 'truck-pickup',
            type = 'client',
            event = 'mr-tow:client:TowVehicle',
            shouldClose = true
        }
    },
    ["mechanic"] = {
    ...
    ["police"] = {
        {
            ...
            icon = 'bell',
            type = 'client',
            event = 'mr-dispatch:client:officerdown',
            shouldClose = true
        }, {
            id = 'checkvehstatus',
            ...
            icon = 'info-circle',
            type = 'client',
            event = 'mr-tunerchip:client:TuneStatus',
            shouldClose = true
        }, {
            id = 'resethouse',
            ...
            icon = 'key',
            type = 'client',
            event = 'mr-houses:client:ResetHouse',
            shouldClose = true
        }, {
            id = 'takeoffmask',
            title = 'remove mask',
            ...
            items = {
                ...
                }, 
                {
                    ...
                    icon = 'search',
                    type = 'client',
                    event = 'police:client:SearchPlayerBag',
                    shouldClose = true
                }, 
                {
                    id = 'jailplayer',
