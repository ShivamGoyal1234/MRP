...
RegisterNetEvent('mr-vehiclefailure:client:RepairVehicle')
AddEventHandler('mr-vehiclefailure:client:RepairVehicle', function()
...
function CleanVehicle(vehicle)
	...
	MRFW.Functions.Progressbar("cleaning_vehicle", "Cleaning the car...", math.random(10000, 20000), false, true, {
		disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
	}, {}, {}, {}, function() -- Done
		MRFW.Functions.Notify("Vehicle cleaned!")
		SetVehicleDirtLevel(vehicle, 0.1)
        SetVehicleUndriveable(vehicle, false)
		WashDecalsFromVehicle(vehicle, 1.0)
		TriggerServerEvent('mr-vehiclefailure:server:removewashingkit', vehicle)
		TriggerEvent('inventory:client:ItemBox', MRFW.Shared.Items["cleaningkit"], "remove")
...
RegisterNetEvent('mr-vehiclefailure:client:SyncWash')
AddEventHandler('mr-vehiclefailure:client:SyncWash', function(veh)
	SetVehicleDirtLevel(veh, 0.1)
	SetVehicleUndriveable(veh, false)
	WashDecalsFromVehicle(veh, 1.0)
end)

RegisterNetEvent('mr-vehiclefailure:client:CleanVehicle')
AddEventHandler('mr-vehiclefailure:client:CleanVehicle', function()
	local vehicle = MRFW.Functions.GetClosestVehicle()
...
RegisterNetEvent('mr-vehiclefailure:client:RepairVehicleFull')
AddEventHandler('mr-vehiclefailure:client:RepairVehicleFull', function()
	local vehicle = MRFW.Functions.GetClosestVehicle()
	if vehicle ~= nil and vehicle ~= 0 then
		local ped = PlayerPedId()
		local pos = GetEntityCoords(ped)
...
RegisterNetEvent('mr-vehiclefailure:client:ugrepair')
AddEventHandler('mr-vehiclefailure:client:ugrepair', function()
	local vehicle = MRFW.Functions.GetClosestVehicle()
	if vehicle ~= nil and vehicle ~= 0 then
		local ped = PlayerPedId()
		local pos = GetEntityCoords(ped)
...
function RepairVehicleFull(vehicle)
	...
	MRFW.Functions.Progressbar("repair_vehicle", "Repairing vehicle..", math.random(40000, 50000), false, true, {
		disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
		...
		MRFW.Functions.Notify("Vehicle repaired!")
		...
		TriggerServerEvent('mr-vehiclefailure:removeItem', "advancedrepairkit")
	end, function() -- Cancel
		TriggerEvent('dpemote:custom:animation', {"c"})
		MRFW.Functions.Notify("Failed!", "error")
		if (IsBackEngine(GetEntityModel(vehicle))) then
...
function RepairVehicleug(vehicle)
	if (IsBackEngine(GetEntityModel(vehicle))) then
        SetVehicleDoorOpen(vehicle, 5, false, false)
    else
        SetVehicleDoorOpen(vehicle, 4, false, false)
	...
	MRFW.Functions.Progressbar("repair_vehicle", "Repairing vehicle..", math.random(40000, 50000), false, true, {
		...
		TriggerServerEvent('mr-vehiclefailure:removeItem', "ugrepairkit")
	end, function() -- Cancel
		TriggerEvent('dpemote:custom:animation', {"c"})
		MRFW.Functions.Notify("Failed!", "error")
		if (IsBackEngine(GetEntityModel(vehicle))) then
...
function RepairVehicle(vehicle)
	...
	MRFW.Functions.Progressbar("repair_vehicle", "Repairing vehicle..", math.random(20000, 30000), false, true, {
		disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
		...
		if engineHealth == 1000.0 then
			MRFW.Functions.Notify("Engine Health is full" , "error")
		elseif engineHealth >= 900.0 then
			SetVehicleEngineHealth(vehicle, 1000.0)
			MRFW.Functions.Notify("Engine Health 100% now" , "success")
		...
		TriggerServerEvent('mr-vehiclefailure:removeItem', "repairkit")
	end, function() -- Cancel
		TriggerEvent('dpemote:custom:animation', {"c"})
		MRFW.Functions.Notify("Failed!", "error")
		if (IsBackEngine(GetEntityModel(vehicle))) then
...
Citizen.CreateThread(function()
    while true do
        ...
        if showPro then
            MRFW.Functions.DrawText3D(pos.x, pos.y, pos.z, TimeLeft .. '~g~%')
        end
    end
end)
					...
					if cfg.sundayDriver and GetVehicleClass(vehicle) ~= 14 then -- Not for boats
						...
						if speed >= 1.0 then
							...
							if brake > 127 then
								...
								exports['mr-mechanicjob']:SetVehicleStatus(MRFW.Functions.GetPlate(vehicle), "brakes", exports['mr-mechanicjob']:GetVehicleStatus(MRFW.Functions.GetPlate(vehicle), "brakes") - 0.01)
							end
...
function DamageRandomComponent()
	...
	exports['mr-mechanicjob']:SetVehicleStatus(MRFW.Functions.GetPlate(vehicle), randomComponent, exports['mr-mechanicjob']:GetVehicleStatus(MRFW.Functions.GetPlate(vehicle), randomComponent) - randomDamage)
end
...
-- 		Wait(7000)
-- 		print('===============================================')
-- 		print('engine', exports['mr-mechanicjob']:GetVehicleStatus(MRFW.Functions.GetPlate(GetVehiclePedIsIn(PlayerPedId())), 'engine'))
-- 		print('body', exports['mr-mechanicjob']:GetVehicleStatus(MRFW.Functions.GetPlate(GetVehiclePedIsIn(PlayerPedId())), 'body'))
-- 		print('radiator', exports['mr-mechanicjob']:GetVehicleStatus(MRFW.Functions.GetPlate(GetVehiclePedIsIn(PlayerPedId())), 'radiator'))
-- 		print('axle', exports['mr-mechanicjob']:GetVehicleStatus(MRFW.Functions.GetPlate(GetVehiclePedIsIn(PlayerPedId())), 'axle'))
-- 		print('brakes', exports['mr-mechanicjob']:GetVehicleStatus(MRFW.Functions.GetPlate(GetVehiclePedIsIn(PlayerPedId())), 'brakes'))
-- 		print('clutch', exports['mr-mechanicjob']:GetVehicleStatus(MRFW.Functions.GetPlate(GetVehiclePedIsIn(PlayerPedId())), 'clutch'))
-- 		print('fuel', exports['mr-mechanicjob']:GetVehicleStatus(MRFW.Functions.GetPlate(GetVehiclePedIsIn(PlayerPedId())), 'fuel'))
-- 		print('===============================================')
-- 	end
-- end)