...
Config.Locations = {
    jobs = {
        ["electrician"] = {
            ...
            [8] = {
                coords = vector4(1652.34, 2564.31, 45.56, 344.25)
            },
            [9] = {
                coords = vector4(1629.98, 2564.34, 45.56, 5.01)
            },
            [10] = {
                coords = vector4(1624.27, 2577.41, 45.56, 263.11)
            }
        }
    },
    ["freedom"] = {
        coords = vector4(1840.5, 2579.24, 46.01, 187.6)
    },
    ["outside"] = {
        coords = vector4(1846.18, 2585.67, 45.67, 271.21)
    },
    ["yard"] = {
        coords = vector4(1818.68, 2594.1, 45.72, 272.77)
    },
    ["middle"] = {
        coords = vector4(1693.33, 2569.51, 45.55, 123.5)
    },
    ["shop"] = {
        coords = vector4(1781.32, 2558.96, 45.67, 354.93)
    },
    spawns = {
        [1] = {
            animation = "bumsleep",
