...
RegisterNetEvent('mr-interior:client:SetNewState')
AddEventHandler('mr-interior:client:SetNewState', function(bool)
	IsNew = bool
end)
...
function CreateApartmentFurnished(spawn)
	...
	exports['mr-eye']:AddBoxZone("apartments-outfits", vector3(-272.99, -962.53, spawn.z), 4.0, 4.1, {
		name="apartmentsOutfits",
		heading=90.1992,
		debugPoly=false,
		minZ=(spawn.z-1.00166),
		maxZ=(spawn.z+2.19834),
		}, {
			options = {
				{
					type = "client",
	...
	exports['mr-eye']:AddBoxZone("apartments-door", vector3(-268.97, -967.06, spawn.z), 0.7, 1.4, {
		name="apartmentsDoor",
		heading=180.1992,
		debugPoly=false,
		minZ=(spawn.z-1.00166),
		maxZ=(spawn.z+1.49834),
		}, {
			options = {
				{
					type = "client",
	...
	exports['mr-eye']:AddBoxZone("apartments-stash", vector3(-265.88, -966.58, spawn.z-1.0), 0.7, 3.3, {
		name="apartmentsstash",
		heading=180.1992,
		debugPoly=false,
		minZ=(spawn.z-1.00166)-1.0,
		maxZ=(spawn.z+0.19834)-1.0,
		minZ=1.27834,
		maxZ=2.47834,
		}, {
			options = {
	...
	exports['mr-eye']:AddBoxZone("apartments-sleep", vector3(-265.94, -962.2, spawn.z-0.7), 2.9, 2.6, {
		name="apartmentssleep",
		heading=180.1992,
		debugPoly=false,
		minZ=(spawn.z-1.67166)-0.7,
		maxZ=(spawn.z+0.57166)-0.7,
		minZ=1.27834,
		maxZ=2.37834,
		}, {
			options = {
