...
function FormatItemInfo(itemData, dom) {
    ...
    if (itemData != null && itemData.info != "") {
        ...
        } else if (itemData.name == "fishingrod") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>Uses left: " + itemData.info.uses + "</p>");
        } else if (itemData.name == "disabler") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>Uses left: " + itemData.info.uses + "</p>");
        } else if (itemData.name == "drill") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>Uses left: " + itemData.info.uses + "</p>");
        } else if (itemData.name == "drillbit") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>Uses left: " + itemData.info.uses + "</p>");
        } else if (itemData.name == "harddrive") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>Uses left: " + itemData.info.uses + "</p>");
        } else if (itemData.name == "plasma") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>Uses left: " + itemData.info.uses + "</p>");
        } else if (itemData.name == "trojan_usb") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>Uses left: " + itemData.info.uses + "</p>");
        } else if (itemData.name == "electronickit") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>Uses left: " + itemData.info.uses + "</p>");
        } else if (itemData.name == "diving_gear") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>Uses left: " + itemData.info.uses + "</p>");
        } else if (itemData.name == "bolt_cutter") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>Uses left: " + itemData.info.uses + "</p>");
        } else if (itemData.name == "gatecrack") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>Uses left: " + itemData.info.uses + "</p>");
        } else if (itemData.name == "tunerlaptop") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>Uses left: " + itemData.info.uses + "</p>");
        } else if (itemData.name == "tunerlaptop2") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>Uses left: " + itemData.info.uses + "</p>");
        } else if (itemData.name == "lockpick") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>Uses left: " + itemData.info.uses + "</p>");
        } else if (itemData.name == "advancedlockpick") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>Uses left: " + itemData.info.uses + "</p>");
        } else if (itemData.name == "parachute") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>Uses left: " + itemData.info.uses + "</p>");
        } else if (itemData.name == "screwdriverset") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>Uses left: " + itemData.info.uses + "</p>");
        } else if (itemData.name == "tablet2") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>Uses left: " + itemData.info.uses + "</p>");
        } else if (
