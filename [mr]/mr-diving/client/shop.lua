...
--             for k, v in pairs(MR-Diving.SellLocations) do
...
--                         if MR-Diving.SellCoral then
--                             if IsControlJustPressed(0, 47) then
--                                 LocalPlayer.state:set("inv_busy", true, true)
--                                 TaskStartScenarioInPlace(PlayerPedId(), "WORLD_HUMAN_STAND_IMPATIENT", 0, true)
--                                 MRFW.Functions.Progressbar("sell_coral_items", "Check Pockets To Sell Coral", math.random(2000, 4000), false, true, {}, {}, {}, {}, function() -- Done
--                                     ClearPedTasks(PlayerPedId())
--                                     TriggerServerEvent('mr-diving:server:SellCoral')
--                                     notInteressted = true
