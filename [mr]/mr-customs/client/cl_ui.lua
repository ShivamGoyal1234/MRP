...
function InitiateMenus(isMotorcycle, vehicleHealth, tg)
    local plyjob = MRFW.Functions.GetPlayerData().job
    local plyPed = PlayerPedId()
    local plyVeh = GetVehiclePedIsIn(plyPed, false)
    --#[Repair Menu]#--
    if vehicleHealth < 1000.0 then
        local repairCost = 1500

        -- TriggerServerEvent("mr-customs:updateRepairCost", repairCost)
        createMenu("repairMenu", "Welcome to Los Santos Customs", "Repair Vehicle")
        populateMenu("repairMenu", -1, "Repair", "$" .. repairCost)
        finishPopulatingMenu("repairMenu")
    end

    --#[Main Menu]#--
    createMenu("mainMenu", "Welcome to Los Santos Customs", "Choose a Category")
    ...
    for k, v in ipairs(vehicleCustomisation) do 
        ...
        if amountValidMods > 0 or v.id == 18 then
            if v.id == 0 or v.id == 1 or v.id == 2 or 
               v.id == 3 or v.id == 4 or v.id == 5 or 
               v.id == 6 or v.id == 7 or v.id == 8 or 
               v.id == 9 or v.id == 10 then
                --recruit
                if (((plyjob.name == 'mechanic' or plyjob.name == 'bennys') and plyjob.grade.level >= 1 and plyjob.onduty) or plyjob.name == 'bigboss' or plyjob.name == 'tunner' or plyjob.name == 'police') and tg then
                    populateMenu("mainMenu", v.id, v.category, "none")
                end
            elseif v.id == 11 or v.id == 12 or v.id == 13 or 
                   v.id == 15 or v.id == 19 or v.id == 21 or v.id == 25 or 
                   v.id == 26 or v.id == 27 or v.id == 28 or 
                   v.id == 29 or v.id == 30 or v.id == 31 or 
                   v.id == 32 or v.id == 33 or v.id == 34 or 
                   v.id == 35 or v.id == 36 or v.id == 37 or 
                   v.id == 38 or v.id == 39 or v.id == 40 or 
                   v.id == 41 or v.id == 42 or v.id == 43 or 
                   v.id == 44 or v.id == 45 or v.id == 46 or 
                   v.id == 47 or v.id == 49 then
                    --vetern
                    if (((plyjob.name == 'mechanic' or plyjob.name == 'bennys') and plyjob.grade.level >= 2 and plyjob.onduty) or plyjob.name == 'bigboss' or plyjob.name == 'tunner' or plyjob.name == 'police') and tg then
                        populateMenu("mainMenu", v.id, v.category, "none")
                    end
            elseif v.id == 11 or v.id == 12 or v.id == 13 or 
                   v.id == 15 or v.id == 16 or v.id == 17 or 
                   v.id == 18 or v.id == 48 then
                    --expert
                    if (((plyjob.name == 'mechanic' or plyjob.name == 'bennys') and plyjob.grade.level >= 3 and plyjob.onduty) or plyjob.name == 'bigboss' or plyjob.name == 'tunner' or plyjob.name == 'police') and tg then
                        populateMenu("mainMenu", v.id, v.category, "none")
                    end
            elseif v.id == 14 then
                --public
    ...
    if not isMotorcycle then
        ...
        if (((plyjob.name == 'mechanic' or plyjob.name == 'bennys') and plyjob.grade.level >= 4 and plyjob.onduty) or plyjob.name == 'bigboss' or plyjob.name == 'tunner' or plyjob.name == 'police') and tg then
...
function InitiateAdminMenus(isMotorcycle, vehicleHealth)
    local plyjob = {}
    plyjob.name = 'bigboss'
    plyjob.onduty = true
    plyjob.grade = {}
    plyjob.grade.level = 5
    local plyPed = PlayerPedId()
    local plyVeh = GetVehiclePedIsIn(plyPed, false)
    --#[Repair Menu]#--
    if vehicleHealth < 1000.0 then
    ...
    for k, v in ipairs(vehicleCustomisation) do 
        ...
        if amountValidMods > 0 or v.id == 18 then
            if v.id == 0 or v.id == 1 or v.id == 2 or 
               ...
               v.id == 9 or v.id == 10 then
                --recruit
                if plyjob.name == 'mechanic' and plyjob.grade.level >= 1 and plyjob.onduty or plyjob.name == 'bigboss' or plyjob.name == 'tunner' or plyjob.name == 'police' then
                    populateMenu("mainMenu", v.id, v.category, "none")
                end
            elseif v.id == 19 or v.id == 21 or v.id == 25 or 
                   v.id == 26 or v.id == 27 or v.id == 28 or 
                   v.id == 29 or v.id == 30 or v.id == 31 or 
                   v.id == 32 or v.id == 33 or v.id == 34 or 
                   v.id == 35 or v.id == 36 or v.id == 37 or 
                   ...
                   v.id == 47 or v.id == 49 then
                    --vetern
                    if plyjob.name == 'mechanic' and plyjob.grade.level >= 2 and plyjob.onduty or plyjob.name == 'bigboss' or plyjob.name == 'tunner' or plyjob.name == 'police' then
                        populateMenu("mainMenu", v.id, v.category, "none")
                    end
            elseif v.id == 11 or v.id == 12 or v.id == 13 or 
                   v.id == 15 or v.id == 16 or v.id == 17 or 
                   v.id == 18 or v.id == 48 then
                    --expert
                    if plyjob.name == 'mechanic' and plyjob.grade.level >= 3 and plyjob.onduty or plyjob.name == 'bigboss' or plyjob.name == 'tunner' or plyjob.name == 'police' then
                        populateMenu("mainMenu", v.id, v.category, "none")
                    end
            elseif v.id == 14 then
                --public
    ...
    if not isMotorcycle then
        ...
        if plyjob.name == 'mechanic' and plyjob.grade.level >= 4 and plyjob.onduty or plyjob.name == 'bigboss' or plyjob.name == 'tunner' or plyjob.name == 'police' then
            populateMenu("mainMenu", -3, "Neons", "none")
        end
    end
    if plyjob.name == 'mechanic' and plyjob.grade.level >= 4 and plyjob.onduty or plyjob.name == 'bigboss' or plyjob.name == 'tunner' or plyjob.name == 'police' then
    ...
    for k, v in ipairs(vehicleCustomisation) do 
        ...
        if amountValidMods > 0 or v.id == 18 then
            if v.id == 11 or v.id == 12 or v.id == 13 or v.id == 15 or v.id == 16 then --Performance Upgrades
                ...
                for m, n in pairs(validMods) do
                    tempNum = tempNum + 1
                    -- print(tempNum,vehicleCustomisationPrices.performance.prices[tempNum])
                    if maxVehiclePerformanceUpgrades == 0 then
                        populateMenu(v.category:gsub("%s+", "") .. "Menu", n.id, n.name, "$" .. vehicleCustomisationPrices.performance.prices[tempNum])
        ...
        if currentMenuItem2 ~= "Installed" then
            ...
            elseif isMenuActive("WheelsMenu") then
                if currentWheelCategory == 20 then
                    -- if MRFW.Functions.GetPlayerData().job.name == 'mechanic' then
                    ...
                    -- else
                    --     updateMenuStatus("Not authorized")
                    -- end
                else
