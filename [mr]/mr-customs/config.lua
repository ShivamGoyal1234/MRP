...
bennyGarages = {
    ...
    [1] = {coords = vector4(-323.71, -133.63, 38.67, 69.0), blip = false , useJob = true, job = {"mechanic"}, BlockedVehicle = {['bcat'] = true,['npolblazer']=true,['npolchal']=true,['npolchar']=true,['npolcoach']=true,['npolexp']=true,['npolmm']=true,['npolretinue']=true,['npolstang']=true,['npolvette']=true,['npolvic']=true}},
    [2] = {coords = vector4(-316.09, -113.24, 38.67, 71.03), blip = false , useJob = true, job = {"mechanic"}, BlockedVehicle = {['bcat'] = true,['npolblazer']=true,['npolchal']=true,['npolchar']=true,['npolcoach']=true,['npolexp']=true,['npolmm']=true,['npolretinue']=true,['npolstang']=true,['npolvette']=true,['npolvic']=true}},
    [3] = {coords = vector4(-352.55, -89.93, 38.67, 69.94), blip = false , useJob = true, job = {"mechanic"}, BlockedVehicle = {['bcat'] = true,['npolblazer']=true,['npolchal']=true,['npolchar']=true,['npolcoach']=true,['npolexp']=true,['npolmm']=true,['npolretinue']=true,['npolstang']=true,['npolvette']=true,['npolvic']=true}},
    [4] = {coords = vector4(-35.78, -1053.66, 28.09, 26.33), blip = false , useJob = false, job = {"mechanic"}, BlockedVehicle = {['bcat'] = true,['npolblazer']=true,['npolchal']=true,['npolchar']=true,['npolcoach']=true,['npolexp']=true,['npolmm']=true,['npolretinue']=true,['npolstang']=true,['npolvette']=true,['npolvic']=true}},
    [5] = {coords = vector4(-211.33, -1324.68, 30.58, 319.12), blip = false , useJob = true, job = {"bennys"}, BlockedVehicle = {['bcat'] = true,['npolblazer']=true,['npolchal']=true,['npolchar']=true,['npolcoach']=true,['npolexp']=true,['npolmm']=true,['npolretinue']=true,['npolstang']=true,['npolvette']=true,['npolvic']=true}},
    [6] = {coords = vector4(-189.27, -1274.58, 30.83, 180.67), blip = false , useJob = true, job = {"bennys"}, BlockedVehicle = {['bcat'] = true,['npolblazer']=true,['npolchal']=true,['npolchar']=true,['npolcoach']=true,['npolexp']=true,['npolmm']=true,['npolretinue']=true,['npolstang']=true,['npolvette']=true,['npolvic']=true}},
    [7] = {coords = vector4(1175.1, 2641.14, 37.68, 1.05), blip = false , useJob = false, job = {"mechanic"}, BlockedVehicle = {['bcat'] = true,['npolblazer']=true,['npolchal']=true,['npolchar']=true,['npolcoach']=true,['npolexp']=true,['npolmm']=true,['npolretinue']=true,['npolstang']=true,['npolvette']=true,['npolvic']=true}},
    [8] = {coords = vector4(-1417.63, -445.09, 35.26, 33.71), blip = false , useJob = false, job = {"mechanic"}, BlockedVehicle = {['bcat'] = true,['npolblazer']=true,['npolchal']=true,['npolchar']=true,['npolcoach']=true,['npolexp']=true,['npolmm']=true,['npolretinue']=true,['npolstang']=true,['npolvette']=true,['npolvic']=true}},
    [9] = {coords = vector4(111.6, 6625.86, 31.71, 224.08), blip = false , useJob = false, job = {"mechanic"}, BlockedVehicle = {['bcat'] = true,['npolblazer']=true,['npolchal']=true,['npolchar']=true,['npolcoach']=true,['npolexp']=true,['npolmm']=true,['npolretinue']=true,['npolstang']=true,['npolvette']=true,['npolvic']=true}},
    [10] = {coords = vector4(4511.35, -4519.09, 4.13, 20.55), blip = false , useJob = false, job = {"mechanic"}, BlockedVehicle = {['bcat'] = true,['npolblazer']=true,['npolchal']=true,['npolchar']=true,['npolcoach']=true,['npolexp']=true,['npolmm']=true,['npolretinue']=true,['npolstang']=true,['npolvette']=true,['npolvic']=true}},
    [11] = {coords = vector4(845.19, -3238.7, -99.18, 256.73), blip = false , useJob = true, job = {"bigboss"}, BlockedVehicle = {['bcat'] = true,['npolblazer']=true,['npolchal']=true,['npolchar']=true,['npolcoach']=true,['npolexp']=true,['npolmm']=true,['npolretinue']=true,['npolstang']=true,['npolvette']=true,['npolvic']=true}},
    [12] = {coords = vector4(-1364.37, 160.84, -99.71, 269.04), blip = false , useJob = true, job = {"tunner"}, BlockedVehicle = {['bcat'] = true,['npolblazer']=true,['npolchal']=true,['npolchar']=true,['npolcoach']=true,['npolexp']=true,['npolmm']=true,['npolretinue']=true,['npolstang']=true,['npolvette']=true,['npolvic']=true}},
    [13] = {coords = vector4(469.38, -1068.17, 28.69, 89.09), blip = false , useJob = true, job = {"police"}, AllowedVehicles = {['bcat'] = true,['npolblazer']=true,['npolchal']=true,['npolchar']=true,['npolcoach']=true,['npolexp']=true,['npolmm']=true,['npolretinue']=true,['npolstang']=true,['npolvette']=true,['npolvic']=true}},
}
--[[ bennyLocations = {
...
vehicleCustomisationPrices = {
    cosmetics = {price = 600},
    respray = {price = 1000},
    performance = {prices = {0, 3250, 5500, 10450, 15250, 20500, 30500, 40500, 50500, 60500}},
    turbo = {price = 15000},
    wheels = {price = 600},
