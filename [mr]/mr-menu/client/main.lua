...
RegisterNetEvent('mr-menu:client:openMenu', function(data)
    openMenu(data)
end)

RegisterNetEvent('mr-menu:client:closeMenu', function()
    closeMenu()
end)
        ...
        if data then
            if data.params.event then
                ...
                elseif data.params.isQBCommand then
                    TriggerServerEvent('MRFW:CallCommand', data.params.event, data.params.args)
