...
MRFW.Functions.CreateUseableItem("drone", function(source)
...
MRFW.Functions.CreateUseableItem("drone2", function(source)
    local xPlayer = MRFW.Functions.GetPlayer(source)
...
MRFW.Functions.CreateUseableItem("drone3", function(source)
    local xPlayer = MRFW.Functions.GetPlayer(source)
...
MRFW.Functions.CreateUseableItem("drone4", function(source)
    local xPlayer = MRFW.Functions.GetPlayer(source)
...
MRFW.Functions.CreateUseableItem("drone5", function(source)
    local xPlayer = MRFW.Functions.GetPlayer(source)
...
MRFW.Functions.CreateUseableItem("drone6", function(source)
    local xPlayer = MRFW.Functions.GetPlayer(source)
...
MRFW.Functions.CreateUseableItem("drone7", function(source)
    local xPlayer = MRFW.Functions.GetPlayer(source)
