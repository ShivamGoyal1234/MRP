...
RegisterNetEvent('mr-electrician:server:Payslip', function(drops)
    local src = source
    ...
    TriggerClientEvent('MRFW:Notify', src, 'You were paid $'..payment.. ' - Payment: $'..price.. ' minus $' ..taxAmount.. 'in taxes.', 'success')
end)