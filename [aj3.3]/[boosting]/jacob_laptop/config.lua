...
Config.Alert = 'aj-dispatch' -- qb-dispatch / linden_outlawalert / notification, only use qb-dispatch when its on stable release

Config.Inventory = 'aj-inventory/html/images/' -- qb-inventory/html/images/
