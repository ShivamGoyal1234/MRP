...
--     local storeData = Config.AppleShop
...
SellApple = function()
    MRFW.Functions.TriggerCallback('mr-apple:GetItemData', function(count)
        ...
        TriggerServerEvent("mr-apple:sellapple", function(sold, venisonSold) end)
    end)
end
