RegisterNetEvent('mr-chopshop:wheelanimation')
AddEventHandler('mr-chopshop:wheelanimation', function()
    TriggerEvent('animations:client:EmoteCommandStart', {"mechanic3"})
	MRFW.Functions.Progressbar("wheel", Config.Locale["Wheel"], 7000, false, true, {
...
RegisterNetEvent('mr-chopshop:dooranimation')
AddEventHandler('mr-chopshop:dooranimation', function()
    TriggerEvent('animations:client:EmoteCommandStart', {"mechanic4"})
	MRFW.Functions.Progressbar("Door1", Config.Locale["Door1"], (4000), false, true, {
	    disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
	...
	MRFW.Functions.Progressbar("Door2", Config.Locale["Door2"], (4000), false, true, {
		disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
...
RegisterNetEvent('mr-chopshop:trunkanimation')
AddEventHandler('mr-chopshop:trunkanimation', function()
    TriggerEvent('animations:client:EmoteCommandStart', {"mechanic"})
	MRFW.Functions.Progressbar("Trunk1", Config.Locale["searching"], (4000), false, true, {
	    disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
	...
	Citizen.Wait(4500)
	TriggerEvent('animations:client:EmoteCommandStart', {"mechanic4"})
	MRFW.Functions.Progressbar("Hood1", Config.Locale["Door1"], (4000), false, true, {
	    disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
	...
	Citizen.Wait(4500)
	TriggerEvent('animations:client:EmoteCommandStart', {"pull"})
	MRFW.Functions.Progressbar("Hood2", Config.Locale["Door2"], (4000), false, true, {
		disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
...
RegisterNetEvent('mr-chopshop:hoodanimation')
AddEventHandler('mr-chopshop:hoodanimation', function()
    TriggerEvent('animations:client:EmoteCommandStart', {"mechanic4"})
	MRFW.Functions.Progressbar("Hood1", Config.Locale["Door1"], (4000), false, true, {
	    disableMovement = true,
		disableCarMovement = true,
...
RegisterNetEvent('mr-chopshop:wheelchopanim')
AddEventHandler('mr-chopshop:wheelchopanim', function()
	local ped = PlayerPedId()
	MRFW.Functions.Progressbar("wheel", Config.Locale["chopwheel"], 13000, false, true, {
		disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
...
RegisterNetEvent('mr-chopshop:doorchopanim')
AddEventHandler('mr-chopshop:doorchopanim', function()
	local ped = PlayerPedId()    
	MRFW.Functions.Progressbar("door", Config.Locale["chopdoor"], 13000, false, true, {
		disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
...
RegisterNetEvent('mr-chopshop:hoodchopanim')
AddEventHandler('mr-chopshop:hoodchopanim', function()
	local ped = PlayerPedId()    
	MRFW.Functions.Progressbar("hood", Config.Locale["chophood"], 12500, false, true, {
		disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
...
RegisterNetEvent('mr-chopshop:trunkchopanim')
AddEventHandler('mr-chopshop:trunkchopanim', function()
	local ped = PlayerPedId()
	MRFW.Functions.Progressbar("trunk", Config.Locale["choptrunk"], 12500, false, true, {
		disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
