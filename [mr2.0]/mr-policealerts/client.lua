...
RegisterNetEvent('mr-policealerts:ToggleDuty')
AddEventHandler('mr-policealerts:ToggleDuty', function(Duty)
    PlayerJob.onduty = Duty
end)

RegisterNetEvent('mr-policealerts:client:AddPoliceAlert')
AddEventHandler('mr-policealerts:client:AddPoliceAlert', function(data, forBoth)
    if forBoth then
...
--             TriggerEvent('mr-policealerts:client:AddPoliceAlert', alertdata)
--         end
--     end
-- end)
