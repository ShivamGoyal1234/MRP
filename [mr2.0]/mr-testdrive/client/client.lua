...
RegisterNetEvent('mr-testdrive.receiveInfo')
AddEventHandler('mr-testdrive.receiveInfo', function(bank, name)
    if name then
        profileName = name
    end
    profileMoney = bank
...
RegisterNetEvent('mr-testdrive.successfulbuy')
AddEventHandler('mr-testdrive.successfulbuy', function(vehicleName,vehiclePlate,value)    
    SendNUIMessage(
        {
            type = "successful-buy",
...
RegisterNetEvent('mr-testdrive.notify')
AddEventHandler('mr-testdrive.notify', function(type, message)    
    SendNUIMessage(
        {
            type = "notify",
            typenotify = type,
...
RegisterNetEvent('mr-testdrive.vehiclesInfos')
AddEventHandler('mr-testdrive.vehiclesInfos', function() 
    -- print(vehcategory)
...
function OpenVehicleShop()
    inTheShop = true
    TriggerServerEvent("mr-testdrive.requestInfo")
    TriggerEvent('mr-testdrive.vehiclesInfos')
    Citizen.Wait(1000)
    SendNUIMessage(
        {
            data = vehiclesTable,
...
RegisterNUICallback(
    ...
    function(data, cb)
        ...
        local vehicleProps = MRFW.Functions.GetVehicleProperties(lastSelectedVehicleEntity)
        vehicleProps.plate = newPlate

        TriggerServerEvent('mr-testdrive.CheckMoneyForVeh',data.modelcar, data.sale, data.name, vehicleProps)
...
RegisterNetEvent('mr-testdrive.spawnVehicle')
AddEventHandler('mr-testdrive.spawnVehicle', function(model, plate)    
    local hash = GetHashKey(model)
    ...
    exports['mr-mechanicjob']:SetVehicleStatus(MRFW.Functions.GetPlate(vehicleBuy), 'body', 1000.0)
		    exports['mr-mechanicjob']:SetVehicleStatus(MRFW.Functions.GetPlate(vehicleBuy), 'engine', 1000.0)
		    exports['mr-mechanicjob']:SetVehicleStatus(MRFW.Functions.GetPlate(vehicleBuy), 'fuel', 100)
		    exports['mr-mechanicjob']:SetVehicleStatus(MRFW.Functions.GetPlate(vehicleBuy), 'clutch', 100)
		    exports['mr-mechanicjob']:SetVehicleStatus(MRFW.Functions.GetPlate(vehicleBuy), 'brakes', 100)
		    exports['mr-mechanicjob']:SetVehicleStatus(MRFW.Functions.GetPlate(vehicleBuy), 'axle', 100)
		    exports['mr-mechanicjob']:SetVehicleStatus(MRFW.Functions.GetPlate(vehicleBuy), 'radiator', 100)
    TriggerEvent("vehiclekeys:client:SetOwner", MRFW.Functions.GetPlate(vehicleBuy))
...
RegisterNUICallback(
    ...
    function(data, cb)        
        if Config.TestDrive then
            MRFW.Functions.TriggerCallback('mr-testdrive.ghuu', function(HasItem, type)
                if HasItem then
                    startCountDown = true
                        ...
                        TriggerServerEvent('mr-testdrive.CheckMoneyForTest')
                        ...
                        exports['mr-mechanicjob']:SetVehicleStatus(MRFW.Functions.GetPlate(testDriveEntity), 'body', 1000.0)
		    exports['mr-mechanicjob']:SetVehicleStatus(MRFW.Functions.GetPlate(testDriveEntity), 'engine', 1000.0)
		    exports['mr-mechanicjob']:SetVehicleStatus(MRFW.Functions.GetPlate(testDriveEntity), 'fuel', 100)
		    exports['mr-mechanicjob']:SetVehicleStatus(MRFW.Functions.GetPlate(testDriveEntity), 'clutch', 100)
		    exports['mr-mechanicjob']:SetVehicleStatus(MRFW.Functions.GetPlate(testDriveEntity), 'brakes', 100)
		    exports['mr-mechanicjob']:SetVehicleStatus(MRFW.Functions.GetPlate(testDriveEntity), 'axle', 100)
		    exports['mr-mechanicjob']:SetVehicleStatus(MRFW.Functions.GetPlate(testDriveEntity), 'radiator', 100)
                        TriggerEvent("vehiclekeys:client:SetOwner", MRFW.Functions.GetPlate(testDriveEntity))
                    ...
                    MRFW.Functions.Notify("You don't have enough money", "error")
                    CloseNui() 
