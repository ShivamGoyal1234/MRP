...
RegisterNetEvent("mr-fishing:tryToFish")
AddEventHandler("mr-fishing:tryToFish", function(item)
	TryToFish(item) 
end)

RegisterNetEvent("mr-fishing:calculatedistances")
AddEventHandler("mr-fishing:calculatedistances", pos, function()
