$(document).ready(function () {
  window.addEventListener('message', function (event) {
    ...
    if (item.command == 'open') {
      $("#mr-idcardop").css("display", "block")
      $("#mr-idcardop2").css("display", "none")
      $("#mr-idcardop3").css("display", "none")
      $("#mr-idcardop4").css("display", "none")
      ...
      $("#mr-idcardop").css("display", "none")
    }
  })

  $(document).keyup(function (event) {
    if (event.which == 27) {
      $.post('http://mr-idcard:closeUI')
    }
  })
...
$(document).ready(function () {
  window.addEventListener('message', function (event) {
    ...
    if (item.command == 'jobopen') {
      $("#mr-idcardop").css("display", "none")
      $("#mr-idcardop2").css("display", "none")
      $("#mr-idcardop3").css("display", "block")
      $("#mr-idcardop4").css("display", "none")
...
$(document).ready(function () {
  window.addEventListener('message', function (event) {
    ...
    if (item.command == 'weaponopen') {
      ...
      $("#mr-idcardop2").css("display", "none")
      $("#mr-idcardop3").css("display", "none")
      $("#mr-idcardop4").css("display", "block")
...
$(document).ready(function () {
  window.addEventListener('message', function (event) {
    ...
    if (item.command == 'driveropen') {
      $("#mr-idcardop").css("display", "none")
      $("#mr-idcardop2").css("display", "block")
      $("#mr-idcardop3").css("display", "none")
      $("#mr-idcardop4").css("display", "none")
...
function Convert(pMugShotTxd,id) {
    ...
    getBase64Image(tempUrl, function(dataUrl) {
      	$.post('http://mr-idcard/Answer', JSON.stringify({
			Answer: dataUrl,
			Id: id,
		}));
    })
