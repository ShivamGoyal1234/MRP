...
RegisterNetEvent('mr-idcard:client:open')
AddEventHandler('mr-idcard:client:open', function(csn, name, name2, birth, gender, national, photo)
...
RegisterNetEvent('mr-idcard:client:driveropen')
AddEventHandler('mr-idcard:client:driveropen', function(csn, name, name2, birth, gender, national, photo)
...
RegisterNetEvent('mr-idcard:client:Jobopen')
AddEventHandler('mr-idcard:client:Jobopen', function(csn, name, name2, birth, gender, national, photo)
...
RegisterNetEvent('mr-idcard:client:Weaponopen')
AddEventHandler('mr-idcard:client:Weaponopen', function(csn, name, name2, birth, gender, national, photo)
