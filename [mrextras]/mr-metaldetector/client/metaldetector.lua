...
RegisterNetEvent('police:outsidestash', function()
    TriggerEvent("inventory:client:SetCurrentStash", "Secstash_"..MRFW.Functions.GetPlayerData().citizenid)
    TriggerServerEvent("inventory:server:OpenInventory", "stash", "Secstash_"..MRFW.Functions.GetPlayerData().citizenid, {
    maxweight = 4000000,
    slots = 15,
    })   
    count = true
